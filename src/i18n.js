...
var EN_TRANSLATIONS = {
  ...
  "يظهر تلقائياً للموظف قبل تسجيل الحضور صباحاً": "Shows automatically to employee before morning check-in",
  "كيف يعمل؟": "How does it work?",
  "يظهر من الساعة 4 صباحاً حتى 30 دقيقة قبل بداية الدوام": "Shows from 4 AM until 30 minutes before shift start",
  "مثال: لو دوامك 8 ص → يظهر بين 4:00 و 7:30 ص": "Example: shift 8 AM → shows between 4:00 and 7:30 AM",
  "لا يظهر إذا سجّل الموظف حضوره بالفعل": "Won't show if employee already checked in",
  "مرة واحدة في اليوم لكل موظف": "Once per day per employee",
  "النقاط: +25 نقطة للإجابة الصحيحة": "Points: +25 for correct answer",
  "مصدر الأسئلة": "Question Source",
  "يُختار السؤال تلقائياً وعشوائياً من": "Question is picked randomly from",
  "(تبويب 📚 البنك)": "(📚 Bank tab)",
  "كل سؤال نشط في البنك مُرشَّح للظهور في تحدي الصباح": "Every active question in the bank is eligible for morning challenge",
  "إضافة أسئلة": "Add Questions",
  "في تبويب البنك": "in Bank tab",
  "متابعة الإجابات": "Track Answers",
  "في تبويب الإحصائيات": "in Statistics tab",
  "النقاط للإجابة الصحيحة": "Points for correct answer",
  "إعدادات تحدي الصباح": "Morning Challenge Settings",
  "إعدادات تحدي على السريع": "Flash Challenge Settings",
  "من يستقبل الإشعار؟": "Who receives notifications?",
  "الذين سجّلوا الحضور فقط": "Checked-in only",
  "الموجودون في العمل حالياً": "Currently at work",
  "نوع المؤقّت": "Timer Type",
  "موحّد - ينتهي في نفس الوقت للجميع": "Unified - ends same time for all",
  "فردي - المؤقّت يبدأ عند فتح السؤال": "Per-user - starts when opened",
  "حفظ الإعدادات": "Save Settings",
  "تم الحفظ": "Saved",

  // ────── v7.111 — Morning/Flash Unified Bank Integration ──────
  "بنك موحّد": "Unified Bank",
  "بنك قديم": "Legacy Bank",
  "اختر عشوائياً": "Random Pick",
  ...
  "سياسات المكتب": "Office Policies",
  "الانتقال إلى البنك الموحّد الجديد": "Migrate to Unified Bank",
  "هذا النظام (قديم) لا يزال يعمل — لكن يُفضَّل نقل الأسئلة إلى البنك الجديد المتطوّر مع التصنيفات والإحصائيات": "Legacy system still works — but the new unified bank is recommended (categories + stats)",
  "اذهب إلى:": "Go to:",
  "المحتوى": "Content",
  "بنك الأسئلة": "Question Bank",
  "واضغط زر النقل": "and press the migrate button",
